...
// I should do a function that gets the token info, and from that returns the email.
/*
func main() {
	mail := "admin@gmail.com"
	token, err := generateToken(mail)
	if err != nil {
		panic(err)
	}
	fmt.Print("Token: ")
	...
	token_mail, err := verifyToken(token) //I Should do a function that returns
	...
	fmt.Print("Token should be expired and it isn't.")
}
*/
